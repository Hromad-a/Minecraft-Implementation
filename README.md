...
I used Claude in this repository too — at the beginning mostly for consultation, later, with less time on my hands, for code changes and implementations as well.
